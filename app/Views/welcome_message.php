...
<html lang="en">
    <head>
        ...
        <!-- STYLES -->
        <?php include ('includes/header_styles.html'); ?>
...
<!-- CONTENT -->
        ...
        <div class="further">
            ...
            <section>
                ...
                guides, and then reference documentation for the components that make up the framework. Check the <a href="https://codeigniter4.github.io/userguide" target="_blank">User Guide</a> !</p>
...
<!-- SCRIPTS -->
    <?php include ('includes/footer_scripts.html'); ?>

    <!-- Local Scripts for page customization -->
    <script>
